...
int		try_parse_file(char *pathfile)
{
	...
	g_cube.curr_map.textures.n_wall.img_ptr = mlx_xpm_file_to_image(g_cube.mlx, "texture/TECH_3E.xpm", &g_cube.curr_map.textures.n_wall.img_width, &g_cube.curr_map.textures.n_wall.img_height);
	...
	g_cube.curr_map.textures.s_wall.img_ptr = mlx_xpm_file_to_image(g_cube.mlx, "texture/wall.xpm", &g_cube.curr_map.textures.s_wall.img_width, &g_cube.curr_map.textures.n_wall.img_height);
	g_cube.curr_map.textures.e_wall.img_ptr = mlx_xpm_file_to_image(g_cube.mlx, "texture/wall.xpm", &g_cube.curr_map.textures.e_wall.img_width, &g_cube.curr_map.textures.n_wall.img_height);
	g_cube.curr_map.textures.w_wall.img_ptr = mlx_xpm_file_to_image(g_cube.mlx, "texture/wall.xpm", &g_cube.curr_map.textures.w_wall.img_width, &g_cube.curr_map.textures.n_wall.img_height);
